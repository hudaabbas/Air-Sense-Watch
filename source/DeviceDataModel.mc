...
class DeviceDataModel {
    ...
    private var _airSenseProfile as ProfileModel?;
    ...
    public function initialize(bleDelegate as BLEDelegate, dataModelFactory as DataModelFactory, scanResult as ScanResult) 
    {
    ...
    public function getActiveProfile() as ProfileModel? 
    {
        if (_device != null) {
    ...
    {
        if (_device != null) {
            _airSenseProfile = _dataModelFactory.getEnvironmentModel(_device);
        }
    }
}
