...
{
    private var _bleDelegate as BLEDelegate?;
    ...
    public function onStart(state as Dictionary?) as Void 
    {
        ...
        _bleDelegate = new $.BLEDelegate(_profileManager as ProfileManager);
        _modelFactory = new $.DataModelFactory(_bleDelegate as BLEDelegate, _profileManager as ProfileManager);
